...
# Relations in dimension 1: univariabe analysis for all 11 variables
boxplot(X, las=2, col="darkblue")
# each box represents the variability for each variable (maturity)
# the information contained in each box is univariate

# Relations in dimension 2: bivariate analysis (scatter plots), in total 55
# multiple scatter plot: all relations, 11^2, in dimension 2
ggcorr(X, label = T)
# any information?
